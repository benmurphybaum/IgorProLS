...
2. Then call `igorpro_search_documentation` using the exact canonical name(s) returned by step 1. You may come across links inside a searched topic that are useful, and perhaps a better match, for doing a further investigation.
